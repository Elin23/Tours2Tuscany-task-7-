...
const DestinationCard = ({ img, title, price, day, date, description} : DestinationProps) => { 
  ...
  return (
    <div className='flex flex-col' data-aos="flip-left">
        ...
        <div className='flex flex-col gap-3'>
            <p className='leading-[100%] font-bold text-sm md:text-2xl text-gray-01'>{title}</p>
            <p className='font-semibold text-sm md:text-lg leading-[100%] text-gray-01'>
                from <span className='text-orange text-lg md:text-2xl font-extrabold'>{price}</span>
            </p>
